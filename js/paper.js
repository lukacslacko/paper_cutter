...
function gearMain() {
    ...
    var fOpt = new GearOptions(div * ratF, angle, rollingCircleRadius, 1, 1 + extraDepth, 20, true, "negy.dxf");
    var gOpt = new GearOptions(div * ratF * ratG, angle, rollingCircleRadius, 1 + extraDepth, 1, 20, true, "ot.dxf");
